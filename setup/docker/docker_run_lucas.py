...
if __name__=="__main__":
	...
	cmd += " -v ~/software_tools:%(home_directory)s/software_tools" % {'home_directory': home_directory} # mount additional software tools
	...
	# mount forces pro
	forces_pro_dir = "~/software_tools/forces_pro"
	cmd += " -v %(forces_pro_dir)s:%(home_directory)s/forces_pro " %{'forces_pro_dir': forces_pro_dir, 'home_directory': home_directory}
