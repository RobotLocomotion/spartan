...
namespace spartan {
namespace iiwa_rlg_sim_backend {
namespace {
...
void ImagesToLcmImagesT::CalcImagesT(
  ...
  if (color_image_value) {
    ...
    PackImageToImageT(color_image, msg->utime,
                         bot_core::image_t::PIXEL_FORMAT_RGBA,
                         color_frame_name_, &color_image_msg);
    msg->images.push_back(color_image_msg);
    msg->image_types.push_back(4); // 4 = msg->DEPTH_MM, causing linker trouble...
    msg->n_images++;
  }
