% forcespro_qp_4_contact_point - a fast solver generated by FORCES Pro v1.6.115
%
%   OUTPUT = forcespro_qp_4_contact_point(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = forcespro_qp_4_contact_point(PARAMS) returns additionally
...
%    -100 - License error
%
%   [OUTPUT, EXITFLAG, INFO] = forcespro_qp_4_contact_point(PARAMS) returns 
