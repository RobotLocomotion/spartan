...
#define S_FUNCTION_NAME forcespro_qp_4_contact_point_simulinkBlock
...
typedef forcespro_qp_4_contact_pointinterface_float forcespro_qp_4_contact_pointnmpc_float;
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 0 */
    ssSetInputPortMatrixDimensions(S,  0, 16, 16);
