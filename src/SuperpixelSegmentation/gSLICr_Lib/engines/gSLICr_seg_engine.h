...
namespace gSLICr
{
	namespace engines
	{
		...
		protected:
			...
			virtual void Update_Neighborhood_Connectivity() = 0;
		...
		public:
			...
			const IntImage* Get_Label_Connectivity() const {
				connectivity_img->UpdateHostFromDevice();
