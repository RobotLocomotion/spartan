How to run ground truth annotation tool (GTAT):

	GTAT is an external panel that runs on top of director

	How to use:

	0. For static scenes launch, drake-visualizer --script groundTruthAnnotaionPanel.py 
