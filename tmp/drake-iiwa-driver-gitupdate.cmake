...
execute_process(
  COMMAND "/usr/bin/git" show-ref 6b26135
  WORKING_DIRECTORY "/home/drc/spartan/externals/drake-iiwa-driver"
...
if("${show_ref_output}" MATCHES "refs/remotes/6b26135")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "6b26135")
...
# yet).
execute_process(
  COMMAND "/usr/bin/git" rev-list --max-count=1 6b26135
  WORKING_DIRECTORY "/home/drc/spartan/externals/drake-iiwa-driver"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(error_code)
    message(FATAL_ERROR "Failed to fetch repository 'git@github.com:RobotLocomotion/drake-iiwa-driver.git'")
  endif()
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/drc/spartan/externals/drake-iiwa-driver/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/drc/spartan/externals/drake-iiwa-driver/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
